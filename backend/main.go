...
var furnitureItems = []Furniture{
	...
	{"4", "Queen Bed Frame", "A sturdy and stylish metal bed frame that complements any bedroom decor. Its modern design is perfect for supporting a queen-size mattress while offering a minimalist look.", 499.99, 5, false, "/queenBedFrame.jpg", 20, false},
	...
	{"7", "TV Stand", "A minimalist TV stand with ample storage space for electronics, DVDs, and more. Its clean lines and neutral color make it a perfect addition to any living room.", 349.99, 3, false, "/tvStand.jpg", 0, false},
	...
	{"10", "Sectional Sofa", "This L-shaped sectional sofa is designed for comfort and style. Perfect for large living rooms, it provides ample seating while adding a modern touch to your home.", 1199.99, 5, true, "/sectionalSofa.jpg", 15, false},
	...
	{"15", "Kitchen Island", "This rolling kitchen island with storage space provides extra counter space and organization. Perfect for preparing meals or serving guests, it adds functionality to your kitchen.", 499.99, 1, false, "/Kitchen Island.jpg", 10, false},
	...
	{"19", "Glass Display Cabinet", "This modern glass-door display cabinet allows you to showcase your prized possessions. Its sleek design and sturdy build make it an elegant addition to any living room or hallway.", 549.99, 2, false, "/glass display cabinet.jpg", 15, false},
